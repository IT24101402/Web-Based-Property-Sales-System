...
<head>
    ...
    <title>PropertEase - Feedback Form</title>
...
<div class="popup-overlay" id="popupOverlay">
    <div class="popup">
        ...
        <h2>Thank You!</h2>
        <p>Your feedback has been submitted successfully. We appreciate your input and will use it to improve PropertEase.</p>
